...
import { View, Text, TextInput, type ViewStyle, type TextStyle } from 'react-native';
...
const IdentificationScreen: React.FC = () => {
    ...
    const handleVerifiedUser = () => {
        console.log('Identifying verified user with:', userID, 'and session token:', sessionToken);
